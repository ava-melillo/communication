class Network {
  ...
  showNetwork(signalIndex){
    ...
    for (let a = 0; a < this.nColumns; a++){
      ...
      image(this.img, initialPosition_x - this.curveRadius/2.2 + a * this.spacing_x - 10, 40);
    }
  ...
  addNewMessage(newMessage){
    ...
    this.wires[int(random(this.wires.length - 1))] = new Wire(newMessage, this.fontSize, this.curveRadius);
